...
import ITQuiz from '../Quiz/InsiderThreatsQuiz';
...
function InsiderThreats() {
    ...
    useEffect(() => {
        ...
        const fetchContents = async () => {
            ...
            try {
                const q = query(collection(db, 'insider-threats'), orderBy('timestamp', 'asc'));
    ...
    return (
        ...
        <div className="min-h-screen flex flex-col items-center bg-gray-100">
            ...
            <h2 className="text-4xl font-bold my-6 text-center">INSIDER THREATS</h2>
            ...
            <div className="w-full max-w-6xl p-4 bg-white rounded shadow-md">
                ...
                {currentIndex === contents.length && (
                    <ITQuiz onComplete={handleQuizComplete} />
                )}
