            ...
            <nav className="bg-blue-800 text-white p-4 shadow-md">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    {/* <div className="hidden md:flex space-x-6 justify-center flex-grow">
                        <Link to="/training/data-breaches" className="hover:text-yellow-300 transition duration-300">Data Breaches</Link>
                ...
                <div className={`md:hidden flex flex-col space-y-6 transition-all duration-300 ${navOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                    {/* <Link to="/data-breaches" className="hover:text-yellow-300 mt-6 transition duration-300">Data Breaches</Link>
