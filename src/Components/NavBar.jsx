        ...
        <>
            <nav className="bg-blue-800 text-white p-4 shadow-md">
                ...
                <div className={`md:hidden flex flex-col space-y-5 transition-all duration-300 ${navOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                    ...
                    <Link to="/login" className="bg-blue-400 text-white py-2 px-6 rounded-full hover:bg-blue-600 transition duration-700 ease-in-out transform hover:scale-105">TRAINING</Link>
                </div>
            </nav>
        </>
    );
